...
#include "SceneObject/Component/Collider/BoxCollider.h"
#include "SceneObject/Component/Collider/SegmentCollider.h"
// #include "SceneObject/Component/Collider/CircleCollider.h"
...
void ColliderBase::Draw(const ScreenParams& screen_params)
{
...
void ColliderBase::AddHitTarget(const std::vector<CollisionObjectType>& new_targets)
{
...
void ColliderBase::RemoveHitTarget(const std::vector<CollisionObjectType>& targets_to_remove)
{
	for (const auto& target : targets_to_remove)
	{
		RemoveHitTarget(target);
	}
}
...
void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const BoxCollider* box1, const BoxCollider* box2) const
{
...
void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const BoxCollider* box1, const SegmentCollider* segment2) const
{
...
void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const BoxCollider* box1, const CircleCollider* circle2) const
{
	// TODO: 矩形コライダーと円形コライダーの衝突判定
	throw std::runtime_error("Not implemented yet");
}

void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const BoxCollider* box1, const TriangleCollider* triangle2) const
{
...
void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const SegmentCollider* segment1, const SegmentCollider* segment2) const
{
	// TODO: 線分コライダーと線分コライダーの衝突判定
	throw std::runtime_error("Not implemented yet");
}

void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const SegmentCollider* segment1, const CircleCollider* circle2) const
{
	// TODO: 線分コライダーと円形コライダーの衝突判定
	throw std::runtime_error("Not implemented yet");
}

void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const SegmentCollider* segment1, const TriangleCollider* triangle2) const
{
	throw std::runtime_error("Not implemented yet");
}

void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const CircleCollider* circle1, const CircleCollider* circle2) const
{
	// TODO: 円形コライダーと円形コライダーの衝突判定
	throw std::runtime_error("Not implemented yet");
}

void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const CircleCollider* circle1, const TriangleCollider* triangle2) const
{
	throw std::runtime_error("Not implemented yet");
}

void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const TriangleCollider* triangle1, const TriangleCollider* triangle2) const
{

}


void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const SegmentCollider* segment1, const BoxCollider* box2) const
{
...
void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const CircleCollider* circle1, const BoxCollider* box2) const
{
	HitResult result_for_2;
...
void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const TriangleCollider* triangle1, const BoxCollider* box2) const
{
	HitResult result_for_2;
...
void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const CircleCollider* circle1, const SegmentCollider* segment2) const
{
	HitResult result_for_2;
...
void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const TriangleCollider* triangle1, const SegmentCollider* segment2) const
{
	HitResult result_for_2;
...
void ColliderBase::CheckCollidersHitImpl(HitResult& out_result_for_1, const TriangleCollider* triangle1, const CircleCollider* circle2) const
{
	HitResult result_for_2;
...
bool ColliderBase::HandlePushback(const HitResult& hit_result) const
{
	...
	else
	{
		...
		if (self_is_pushable && other_is_pushable)
		{
			...
			const float self_mass = self_owner->GetMass();
			const float other_mass = other_owner->GetMass();
...
HitResult ColliderBase::MakeHitResult(const ColliderBase* self_collider, const ColliderBase* other_collider, const Vector2D& penetration_depth) const
{
	// OVERLAP
	if (
...
void ColliderBase::DrawDebugLines(const ScreenParams& screen_params, const ColliderDebugDrawDesc& desc)
{
	if(desc.draw_aabb)
	{
		Vector2D screen_world_offset = screen_params.world_offset;
		// 外接AABBの描画
		int x1, x2, y1, y2;
		Vector2D _aabb_left_top, _aabb_right_bottom;
		GetAABB(_aabb_left_top, _aabb_right_bottom);
		Vector2D external_aabb_left_top_screen = Vector2D::WorldToViewport(_aabb_left_top, screen_params);
		Vector2D external_aabb_right_bottom_screen = Vector2D::WorldToViewport(_aabb_right_bottom, screen_params);
		external_aabb_left_top_screen.ToInt(x1, y1);
		external_aabb_right_bottom_screen.ToInt(x2, y2);
