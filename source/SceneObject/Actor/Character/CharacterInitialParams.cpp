...
// maxHp, maxWalkSpeed, maxFlySpeedÇÕ1à»è„ÇÃêÆêî
const std::shared_ptr<EditParamValidator<EditParamType::INT>> CharacterInitialParams::maxHpValidator = 
	std::make_shared<EditParamValidator_Clamp<EditParamType::INT>>(1,999);

const std::shared_ptr<EditParamValidator<EditParamType::INT>> CharacterInitialParams::maxWalkSpeedValidator =
	std::make_shared<EditParamValidator_Clamp<EditParamType::INT>>(50,999);

const std::shared_ptr<EditParamValidator<EditParamType::INT>> CharacterInitialParams::maxFlySpeedValidator =
	std::make_shared<EditParamValidator_Clamp<EditParamType::INT>>(50,999);