...
protected:
	...
	static const std::shared_ptr<EditParamValidator<EditParamType::INT>> maxHpValidator;
	static const std::shared_ptr<EditParamValidator<EditParamType::INT>> maxWalkSpeedValidator;
	static const std::shared_ptr<EditParamValidator<EditParamType::INT>> maxFlySpeedValidator;
};