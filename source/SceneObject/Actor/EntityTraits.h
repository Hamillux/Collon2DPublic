...
/// <summary>
/// Entityの情報を提供するstaticクラス
/// </summary>
class EntityTraits
{
public:
	static const char* GetName(const EEntityType entity_type);
	static const char* GetDisplayName(const EEntityType entity_type);
	static MasterDataID GetEntityID(const EEntityType entity_type);
	static std::shared_ptr<ActorInitialParams> GetDefaultInitialParamsOf(const EEntityType entity_type);
	static std::shared_ptr<ActorInitialParams> GetDefaultInitialParamsOf(const MasterDataID entity_id);
};
/// <summary>
