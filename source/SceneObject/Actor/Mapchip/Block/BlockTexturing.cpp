...
const std::unordered_map<TileType, BlockTextureMapping::TextureRegion> BlockTextureMapping::_tile_texture_region_map =
{
	...
	{TT::H2_2,	{div16(5),	div16(10),	div16(4),	div16(12)}},
...
void BlockTextureMapping::GetTileTextureRegion(
	float& out_u0,
	float& out_v0,
	float& out_u1,
	float& out_v1,
...
)
{
	...
	GetTileTextureRegion(out_u0, out_v0, out_u1, out_v1, tile_type);
}

void BlockTextureMapping::GetTileTextureRegion(float& out_u0, float& out_v0, float& out_u1, float& out_v1, const TileType tile_type)
{
