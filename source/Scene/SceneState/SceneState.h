...
public:
	...
	// 何もしない
	virtual void UpdateScreenParams(ParentSceneClass& parent_scene, const float delta_seconds) {}
...
public:
	...
	void UpdateScreenParams(ParentSceneClass& parent_scene, const float delta_seconds)
	{
		GetCurrentState()->UpdateScreenParams(parent_scene, delta_seconds);
	}
