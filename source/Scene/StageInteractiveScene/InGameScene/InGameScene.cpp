...
void InGameScene::Initialize(const SceneBaseInitialParams* const scene_params)
{
	...
	{
		_was_actor_init_pos_in_spawn_area[actor] = false;
	}
...
void InGameScene::UpdateScreenParams(const float delta_seconds)
{
	__super::UpdateScreenParams(delta_seconds);
...
{
	return FCircle(_screen_params.world_offset, _spawn_area_radius);
}
