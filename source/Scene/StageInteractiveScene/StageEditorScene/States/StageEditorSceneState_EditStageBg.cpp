...
namespace
{
	...
	constexpr float PREVIEW_U0 = 0.3;
	constexpr float PREVIEW_V0 = 0.2;
	constexpr float PREVIEW_U1 = PREVIEW_U0 + 0.575;
	constexpr float PREVIEW_V1 = PREVIEW_V0 + 0.575;

	constexpr float OK_BUTTON_CENTER_U = PREVIEW_U0 + (PREVIEW_U1 - PREVIEW_U0) * 0.25;
	constexpr float CANCEL_BUTTON_CENTER_U = PREVIEW_U0 + (PREVIEW_U1 - PREVIEW_U0) * 0.75;
	constexpr float BUTTON_CENTER_V = 0.925;
}
