...
void StageEditorSceneState_ResizeStage::OnEnterState(ParentSceneClass& parent_scene)
{
	...
	_last_screen_params = parent_scene._screen_params;
}
...
void StageEditorSceneState_ResizeStage::OnLeaveState(ParentSceneClass& parent_scene)
{
	...
	parent_scene._screen_params = _last_screen_params;
...
void StageEditorSceneState_ResizeStage::UpdateScreenParams(ParentSceneClass& parent_scene, const float delta_seconds)
{
	parent_scene._screen_params.screen_scale = parent_scene.GetMaxScreenScale();
	parent_scene._screen_params.world_offset.x = FLT_MAX;
}
