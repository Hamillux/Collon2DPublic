...
struct AnimPlayInfo
{
	...
	float play_speed; // Ä¶‘¬“x [default]1.f
	float ex_rate;	// Šg‘å—¦ [default]1.f
	int reverse_x;	// X•ûŒü”½“] [default]FALSE
	int reverse_y;	// Y•ûŒü”½“] [default]FALSE
	...
	/// 
	/// </summary>
	/// <param name="animation_id_">ƒAƒjƒ[ƒVƒ‡ƒ“ID</param>
	/// <param name="play_speed_">Ä¶‘¬“x</param>
	/// <param name="ex_rate_">Šg‘å—¦</param>
	/// <param name="reverse_x_">X•ûŒü”½“]</param>
	/// <param name="reverse_y_">Y•ûŒü”½“]</param>
	constexpr AnimPlayInfo(
