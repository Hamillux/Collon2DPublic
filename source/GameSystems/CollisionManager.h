...
/// <para>あるコライダーColliderXが衝突し得るのは, ColliderXが所属するノードと, その子孫ノードと祖先ノード に所属するコライダー</para>
/// </summary>
struct KdNode
{
	/// <summary>
...
public:
	...
	void DrawPartition(const KdNode* node, const ScreenParams& screen_params, const int line_color) const;
	...
	void DrawCells(const ScreenParams& screen_params, const uint8_t nodes_depth = 0) const;
